<div class="content-wrapper">
    ...
    <section class="content mt-4">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo base_url('admin/penjualan/create') ?>" method="POST">
                    <div class="d-flex justify-content-lg-end">
                        <label for="" class="">Tanggal</label>
                    </div>
                    <div class="d-flex justify-content-lg-end">
                        <div class="col-lg-4">
                            <input type="date" name="tanggal_beli" id="tanggal_beli" class="form-control mb-3 text-center">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-9 ml-auto">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control w-75" name="nama" placeholder="Nama Pembeli" required>
                            </div>
                            <div class="form-group">
                                <label for="">Alamat</label>
                                <input type="text" class="form-control w-75" name="alamat" placeholder="Alamat" required>
                            </div>
                            <div class="form-group">
                                <label for="">Nomor HP</label>
                                <input type="text" class="form-control w-75" name="nohp" placeholder="Nomor Hp" required>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control w-75" name="title" id="title">
                            </div>
                            <div class="form-group">
                                <label for="">Harga Jual</label>
                                <input type="number" class="form-control w-75" onkeypress="return angka(event)" name="harga" placeholder="Harga Jual" id="harga" onkeyup="tambah()" required>
                            </div>
                            <div class="form-group">
                                <label for="">Jumlah</label>
                                <input type="number" class="form-control w-75" onkeypress="return angka(event)" name="jumlah" id="jumlah" placeholder="Jumlah Barang" onkeyup="tambah()" required>
                            </div>
                            <div class="form-group">
                                <label for="">Total</label>
                                <input type="text" class="form-control w-75 text-right" name="total" id="total" placeholder="Total Harga keseluruhan" readonly>
                            </div>
